    ...
    <div className={classes.root}>
      <AppBar position="static">
        <Toolbar>
          ...
          <Button className={classes.button} variant="text" color="inherit" size="large" startIcon={<DevicesOtherIcon />} component={Link} to="/adddevice">Add Device</Button>
          <Button className={classes.button} variant="text" color="inherit" size="large" startIcon={<DeviceHubIcon />} component={Link} to="/adddeviceset">Add Device Set</Button>
          <Button className={classes.button} variant="text" color="inherit" size="large" startIcon={<PersonAddIcon />} component={Link} to="/signup">Add User</Button>
