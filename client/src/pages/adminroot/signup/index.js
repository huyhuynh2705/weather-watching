...
function SignUp() {
  ...
  const handleSubmit = (e) => {
      ...
      if (form.password !== form.confirmPassword) {
          ...
          dispatch(signup(form)).then(() => history.push('/admin'))
          console.log(form)
      }
    };
      ...
      <Paper className={classes.root}>
        <form onSubmit={handleSubmit}>
            <Grid container spacing={3}>
              ...
              <Grid item xs={8} sm={7}>
                  <TextField className={classes.text} required autoComplete="false" label="Full Name" variant="outlined" name="name" onChange={handleChange}/>
              </Grid>
              <Grid item xs={4} sm={5}>
              ...
              <Grid item xs={8} sm={7}>
                  <TextField className={classes.text} required autoComplete="false" label="Username" variant="outlined" name="username" onChange={handleChange}/>
              </Grid>
              <Grid item xs={4} sm={5}>
                  <Typography className={classes.title} align="right" gutterBottom>Password: </Typography>
              </Grid>
              <Grid item xs={8} sm={7}>
                  <TextField className={classes.text} required autoComplete="false" label="Password" type="password" variant="outlined" name="password" onChange={handleChange}/>
              </Grid>
              <Grid item xs={4} sm={5}>
                  <Typography className={classes.title} align="right" gutterBottom>Confirm password: </Typography>
              </Grid>
              <Grid item xs={8} sm={7}>
                  <TextField className={classes.text} required autoComplete="false" label="Confirm Password" type="password" variant="outlined" name="confirmPassword" onChange={handleChange}/>
              </Grid>
              <Grid item xs={4} sm={5}>
                  <Typography className={classes.title} align="right" gutterBottom>Role: </Typography>
              </Grid>
              <Grid item xs={8} sm={7}>
                  <TextField className={classes.text} required autoComplete="false" label="User / Admin" variant="outlined" name="role" onChange={handleChange}/>
              </Grid>
